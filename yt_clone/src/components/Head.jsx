...
const Head = () => {
  ...
  return (
    <div className="w-full h-28  flex justify-between items-center border shadow-lg">
      ...
      <div className="w-1/2 h-11 border-2 border-solid border-black flex items-center justify-between rounded-full ">
        <input type="text" className="w-[90%] ml-5 h-full outline-none" />
